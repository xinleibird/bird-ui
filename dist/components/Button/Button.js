...
var Button = function (_a) {
    var _b;
    var className = _a.className, size = _a.size, btnType = _a.btnType, children = _a.children, _c = _a.disabled, disabled = _c === void 0 ? false : _c, _d = _a.type, type = _d === void 0 ? 'button' : _d, loading = _a.loading, _e = _a.onLoading, onLoading = _e === void 0 ? function () { } : _e, onlyIcon = _a.onlyIcon, restProps = __rest(_a, ["className", "size", "btnType", "children", "disabled", "type", "loading", "onLoading", "onlyIcon"]);
    ...
    return useMemo(function () {
        return (React.createElement("button", __assign({ className: classes, disabled: disabled || isLoading, type: type }, restProps, { onClickCapture: function (e) {
                e.preventDefault();
